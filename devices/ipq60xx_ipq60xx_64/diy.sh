...
#sed -i "/KernelPackage,switch-ar8xxx/d" package/kernel/linux/modules/netdevices.m

rm -rf feeds/kiddin9/base-files

#rm -rf feeds/kiddin9/{base-files,fullconenat-nft,oaf,rkp-ipid,shortcut-fe} package/feeds/packages/{v4l2loopback,ovpn-dco,libpfring,mdio-netlink,batman-adv,wireguard,jool,openvswitch,xtables-addons} package/kernel/{nat46,ath10k-ct,button-hotplug} package/feeds/ipq807x/{wireguard,batman-adv} package/kernel/mt76
...
sed -i "/CPU_SUBTYPE/d" target/linux/ipq60xx/Makefile
