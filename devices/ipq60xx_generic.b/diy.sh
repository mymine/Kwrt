...
rm -rf devices/common/patches/{fix.patch,targets.patch,kernel-defaults.patch,LINUX_VERSION.patch} target/imagebuilder package/network/config/netifd feeds/kiddin9/{rtl*,dnsmasq,fullconenat*,shortcut-fe} target/linux/generic/files package/feeds/luci/rpcd-mod-luci
...
sed -i "s/PKG_SOURCE_DATE:=.*/PKG_SOURCE_DATE:=2099-12-06/" feeds/kiddin9/fullconenat/Makefile
